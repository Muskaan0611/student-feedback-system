    ...
    <div class="search-box">
        ...
        <form id="search-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="GET">
            ...
            <div class="faculty-select">
               <label for="faculty">Faculty Name: 
    <select name="faculty" id="faculty" class="big-select">
...
// Add faculty filter if provided and not "Select"
if (!empty($faculty) && $faculty != "Select") {
    $sql .= " AND b.faculty = '$faculty'";
}

// Add date range filter if both from-date and to-date are provided
if (!empty($fromDate) && !empty($toDate)) {
    $sql .= " AND b.form_date BETWEEN '$fromDate' AND '$toDate'";
}
...
if ($result->num_rows > 0) {
    ...
    // Close the last feedback table and course-details-box
    echo "</table>"; // Close feedback table
